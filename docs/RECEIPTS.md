...
- Дата
- Сумма
- Описание (из названия товара или продавца)
- Способ оплаты
...
1. Название первого товара из списка
2. Название продавца (ООО, ИП)
...
- `1: Название товара` (с ценой в следующей строке)
- `Название товара    123.45` (цена в конце строки)
- `Общая стоимость позиции... 900.00` (обновление цены последнего товара)
