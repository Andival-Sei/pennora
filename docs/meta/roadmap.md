...
**Текущее состояние:** 25% покрытия (22 файла тестов)

**Задачи:**

- [ ] Добавить тесты для `lib/sync/syncManager.ts` (критичный модуль)
- [ ] Добавить тесты для `lib/sync/queueManager.ts`
...
- [ ] Настроить CI/CD для запуска тестов при каждом PR
