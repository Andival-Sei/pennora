...
interface ExpenseSimpleFormProps {
...
/**
 * Форма для простого расхода (одна позиция)
 * Поля: Сумма, Счёт, Категория (расходные), Дата, Описание
 */
export function ExpenseSimpleForm({
  prefilledData,
  editData,
  onSuccess,
}: ExpenseSimpleFormProps) {
