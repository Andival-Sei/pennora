    ...
    <footer className="relative border-t border-zinc-800/50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Links */}
          <div className="space-y-4">
            <h4 className="text-white font-semibold">{t("links.title")}</h4>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              <h4 className="text-white font-semibold">{t("contact.title")}</h4>
            ...
            <p className="text-zinc-400 text-sm">{t("contact.description")}</p>
